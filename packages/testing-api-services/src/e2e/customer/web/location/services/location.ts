import { CustomerLocationServiceClient } from '@api/customer/gen/ts/customer/proto/customer/web/LocationServiceClientPb';
import {
  Coordinates,
  OrderByItem,
  PaginationReq,
} from '@api/customer/gen/ts/customer/proto/customer/web/base_pb';
import {
  CreateMyLocationReq,
