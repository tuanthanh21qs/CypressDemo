import { UpdateMyLocationReq } from '@api/customer/gen/ts/customer/proto/customer/web/location_pb';
import { dataUpdateMyLocation } from '../data/updateMyLocation';
import { updateMyLocation } from '../services/location';

let token = dataUpdateMyLocation.token.correct;
