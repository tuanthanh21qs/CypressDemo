...
//       cy.wrap(login(data, {}).catch((err) => err)).then(
//         (res: LoginRes.AsObject) => {
//           expect(res.message).to.equal('Phone is required');
//         }
//       );
//     });
//   });
...
//       cy.wrap(login(data, {}).catch((err) => err)).then(
//         (res: LoginRes.AsObject) => {
//           expect(res.message).to.equal('Email is required');
//         }
//       );
//     });
//   });
...
describe('Partnership - Login', () => {
  it('Verify Partnership Login Successfull', () => {
    ...
    cy.wrap(login(data, {}).catch((err) => err)).then(
      (res: LoginRes.AsObject) => {
        ...
        cy.wrap(res.expireTime).as('Expired');

        expect(res.accessToken).not.to.be.empty;
      }
    );
  });
  it('Verify Partnership Login Failed when Phone Number incorrect', () => {
    data.partnershipId = dataLogin.partnershipId.correct;
    data.password = dataLogin.password.correct;
    data.phoneCode = dataLogin.phoneCode.correct;
    ...
    cy.wrap(login(data, {}).catch((err) => err)).then(
      (res: LoginRes.AsObject) => {
        expect(res.message).to.equal('Không tìm thấy tải khoản của bạn');
      }
    );
  });
  it('Verify Partnership Login Failed when Phone Number empty', () => {
    data.partnershipId = dataLogin.partnershipId.correct;
    data.password = dataLogin.password.correct;
    data.phoneCode = dataLogin.phoneCode.correct;
  ...
  it('Verify Partnership Login Failed when Password incorrect', () => {
    data.partnershipId = dataLogin.partnershipId.correct;
  ...
  it('Verify Partnership Login Failed when Password empty', () => {
    data.partnershipId = dataLogin.partnershipId.correct;
